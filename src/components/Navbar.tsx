  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-background/80 backdrop-blur-md">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <a href="#top" className="flex items-center gap-2 font-extrabold uppercase tracking-widest">
          <span className="text-lg">Matlock&apos;s</span>
          <span className="hidden text-sm font-medium text-white/60 sm:inline">Tune Shop</span>
        </a>
